...
const wordsLength=wordsExercise4.map(words =>words.length)
...
const stringToNumbers=numbersExercise6.map(number => number.toString());
console.log('ex 6',stringToNumbers);
// Exercise 7:
...
const wordsToSplit=sentencesExercise7.map(words =>words.split(' '));
console.log('ex 7 ', wordsToSplit);
// Exercise 8:
...
const userEmail=usersExercise8.map((user, index)=>"Current user is "+ index + " " + user.email);
...
const booksTitlesAndAuthors=booksExercise9.map((books, index)=>"Current element is "+ index + " " + books.title+' '+books.author);
console.log('ex 9',booksTitlesAndAuthors);
