...
const numberToString = numbersExercise6.map(number => number.toString());
console.log('Ex. 6', numberToString);
...
const splitSentencesIntoWords = sentencesExercise7.map(sentence => sentence.split(' '));
console.log('Ex. 7', splitSentencesIntoWords);
...
console.log('Ex. 8', eMailAddresses);
...
const bookTitlesAndAuthors = booksExercise9.map(book => book.title + ':'  + ' ' + book.author);
console.log('Ex. 10', bookTitlesAndAuthors);
...
console.log('Ex. 10', pricesWithCurrencySymbol);
