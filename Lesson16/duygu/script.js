...
function checkVotingAge(age, isStudent) {
	if (age < 18 && isStudent) {
...
console.log(checkVotingAge(32, yes));
...
function evaluateJobOffer(salary, experience) {
...
console.log(evaluateJobOffer(50000, 8));
