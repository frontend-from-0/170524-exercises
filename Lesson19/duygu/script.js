...
class Car extends Vehicle{
  ...
  start(){
      console.log(`${this._make} ${this._model} (${this._year}) with ${this._numWheels} wheels has started.`);;
  }
}
const vehicleOne=new vehicle('Fiat','500','2020',4);
vehicleOne.start();

const carOne=new Car('Tesla','Cybertruck','2021');
carOne.start();
...
const myAccount = new BankAccount(600, 0.05);

myAccount.deposit(200);
myAccount.withdraw(800); 

console.log("Transaction History:", myAccount.getTransactionHistory());
console.log("Current Balance:", myAccount.getCurrentBalance());
