...
const { name: personName, age } = personE14;
...
const user8Name = userEx8?.profile?.name;
const userCity = userEx8?.profile?.address?.city;
console.log(user8Name, userCity); 
...
const user9Country=userEx9?.profile?.address?.country??"Unknown";
console.log(user9Country);
...
const user10=userEx10?.profile?.getName?.() ??"No Name";
console.log(user10);
...
const fantasyTitle =library.sections?.fantasy?.books?.[0]?.title;
...
let displayTitleOr =userTitle || "Untitled";
